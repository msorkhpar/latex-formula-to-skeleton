...
if __name__ == '__main__':
    ...
    output_dir = os.path.abspath(os.getenv("INPUT_PATH", "./output"))
    png_size = int(os.getenv("PNG_SIZE", "1024"))
    paths = {
        "tex": os.path.abspath(os.getenv("TEX_DIR_PATH", f"{output_dir}/tex")),
        "dvi": os.path.abspath(os.getenv("DVI_DIR_PATH", f"{output_dir}/dvi")),
        "svg": os.path.abspath(os.getenv("SVG_DIR_PATH", f"{output_dir}/svg")),
        "png": os.path.abspath(os.getenv("PNG_DIR_PATH", f"{output_dir}/png")),
        "png_t": os.path.abspath(os.getenv("PNG_TRANSPARENT_DIR_PATH", f"{output_dir}/png_transparent")),
        "skeleton": os.path.abspath(os.getenv("SKELETON_DIR_PATH", f"{output_dir}/skeleton")),
    }
